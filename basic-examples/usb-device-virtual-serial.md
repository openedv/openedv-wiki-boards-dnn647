...
这是一个 USB 从机的实验，在 STM32N647 开发板上实现了 USB 虚拟串口的功能。

本实验对应的工程文件夹为：`<STM32N647 开发板软件包路径>/Projects/54_USB_Device_Virtual_Serial`。
...
4. 使用 USB Type-C 数据线将串口调试助手的物理机与 STM32N647 开发板的 `USB SLAVE` 接口连接。
