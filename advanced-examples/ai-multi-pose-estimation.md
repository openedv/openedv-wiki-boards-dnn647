...
这是一个机器视觉的应用案例，实现了在 STM32N647 开发板上部署姿态估计模型的实验。

:::info[预训练模型说明]

预训练模型文件来自 [**STM32 Model Zoo**](https://github.com/STMicroelectronics/stm32ai-modelzoo/tree/v3.0.0/pose_estimation/yolov8n_pose)。

:::

本实验对应的工程文件夹为：`<STM32N647 开发板软件包路径>/Projects/99_Applications/994_AI_Multi_Pose_Estimation`
...
LCD 上实时显示摄像头采集的画面图像，并在图像上绘制出检测到的人体姿态估计框。
